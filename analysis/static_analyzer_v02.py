...
def parse_array_access(
    ...
    """
    Extract an array access directly from the
    original source-code range represented by
    ...
    #
    # Rebuild a normalized expression.
    #
    normalized = array_name
