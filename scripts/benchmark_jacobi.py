...
BUILD_DIR = PROJECT_ROOT / "build" / "jacobi-2d"
RESULTS_DIR = PROJECT_ROOT / "results" / "jacobi-2d"

BUILD_DIR.mkdir(parents=True, exist_ok=True)
RESULTS_DIR.mkdir(parents=True, exist_ok=True)

BINARY = BUILD_DIR / "jacobi_openmp_time"
...
SEQUENTIAL_BASELINE = 2.561923


def compile_program():

    print("[1/3] Compilando Jacobi-2D OpenMP...")
